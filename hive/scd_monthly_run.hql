...
dfs -rm -skipTrash /user/sahilbhange/yelp_stg_text/*;
dfs -rm -skipTrash /user/sahilbhange/yelp_stg_orc/*;

-- Load CSV file data to 'yelp_user_stg_text' table
dfs -copyFromLocal /home/sahilbhange/landing/yelp_data/yelp_user_${hiveconf:FILE_DATE}.csv /user/sahilbhange/yelp_stg_text/.;
...
dfs -rm -r -skipTrash /user/sahilbhange/yelp_hist/*;


-- Move HIST_STG data to HIST table
dfs -mv /user/sahilbhange/yelp_data_hist_stg/* /user/sahilbhange/yelp_hist/.;
